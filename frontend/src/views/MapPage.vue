        ...
        <div class="detail-content">
          <template v-if="selectedPlace">
            ...
            <div class="detail-section">
              <h4 class="section-title"><i class="fas fa-info-circle"></i> 地点简介</h4>
              <p style="color: #5c4033; line-height: 1.6">{{ selectedPlace.description }}</p>
            </div>

            <div class="detail-section">
              <h4 class="section-title"><i class="fas fa-history"></i> 时间线事件</h4>
  ...
  mounted() {
    ...
    addMapControls() {
      ...
      for (let i = 0; i < sortedData.length; i++) {
          ...
          console.log(
            `🎯 创建标记 ${place.orderNumber}: ${place.name}, type: ${place.type}, color:`,
